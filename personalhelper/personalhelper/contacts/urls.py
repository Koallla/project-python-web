...
urlpatterns = [
    ...
    path('show_contacts/<int:pk>/delete', views.ContactDeleteView.as_view(), name='contact-delete'),
    path('show_contacts/<int:pk>/add_phone', views.AddPhone.as_view(), name='add-phone'),
    path('show_contacts/add_phone/<int:id>', views.add_phone, name='add_phone'),
